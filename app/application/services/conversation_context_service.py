...
from app.domain.entities.chat_message import ChatMessage, MessageIntent, EntityMention, SourceRef
...
INTENT_KEYWORDS = {
    MessageIntent.FILE_REQUEST: [
        "mẫu đơn", "tải file", "download", "xin mẫu", "cho mẫu", "file", "form"
    ],
    MessageIntent.CLARIFICATION: [
        "nghĩa là gì", "có nghĩa là", "giải thích", "nói rõ hơn", "ý bạn là"
    ],
    MessageIntent.FEEDBACK: [
        "cảm ơn", "thanks", "ok", "được rồi", "hiểu rồi", "tốt lắm"
    ],
