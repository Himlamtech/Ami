...
class QualityValidatorUseCase:
    ...
    def _check_metadata(self, metadata: Dict[str, Any], result: ValidationResult) -> None:
    ...
    def _check_content_age(self, created_at: datetime, result: ValidationResult) -> None:
