...
async def schedule_sync(request: ScheduleSyncRequest):
    ...
    try:
        ...
        return SyncJobResponse(
            ...
            next_run_time=datetime.fromisoformat(job_info["next_run_time"]) if job_info and job_info.get("next_run_time") else None,
            trigger=request.schedule_type,
            status="scheduled",
        )
    ...
    try:
        ...
        return [
            SyncJobResponse(
                ...
                next_run_time=datetime.fromisoformat(job["next_run_time"]) if job.get("next_run_time") else None,
