"""Vector database routes - Refactored."""

from fastapi import APIRouter, UploadFile, File, Form, HTTPException, status
from typing import Optional

from app.presentation.api.schemas.document_dto import (
    DocumentResponse,
...
async def upload_document(
    ...
    try:
        ...
        class SimpleChunker(ITextChunker):
            def chunk_text(self, text, chunk_size=512, chunk_overlap=50, strategy="fixed"):
                chunks = []
...
async def delete_document(document_id: str):
    ...
    try:
        ...
        result = await use_case.execute(
            DeleteDocumentInput(document_id=document_id)
        )
