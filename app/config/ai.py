...
class GeminiConfig(BaseConfig):
    ...
    gemini_model_qa: str = Field(default="gemini-2.0-flash")
    gemini_model_reasoning: str = Field(default="gemini-2.5-pro-preview-05-06")
    gemini_image_model: str = Field(default="gemini-1.5-vision-preview-20240415")
    # Convenience properties
    @property
    def api_key(self) -> str:
...
class STTConfig(BaseConfig):
    ...
    stt_model: str = Field(
        default="nguyenvulebinh/wav2vec2-base-vi-vlsp2020"
    )
